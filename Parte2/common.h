...
// FICHEIRO DO PROFESSOR, NAO MODIFICAR
...
#define NUM_VAGAS 2          // Número de vagas de cidadãos que poderão estar a ser vacinados simultâneamente
